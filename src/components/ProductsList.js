...
const ProductsList = () => {
  ...
  useEffect(()=>{
    ...
    <div className="text-center p-10 mt-44">
        <h1 className="font-bold text-4xl mb-4">M-Store Products</h1>
        <h5>By: Usama Hassan</h5>
    </div>
...

    {
        ...
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                ...
                <p className='truncate'>{product.description}</p> <br />
